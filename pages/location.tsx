  ...
  return (
    <React.Fragment>
      ...
      <Wrapper>
        ...
        <Main>
            <PageHeader>Directions to our location</PageHeader>
            <Image src="/crossfit-oddity/images/location.webp" height="400" width="700"></Image>
            <p>
              When you turn onto Research Blvd, our location is accessed between two buildings on the right.
            </p>
        </Main>
      </Wrapper>
    </React.Fragment>
